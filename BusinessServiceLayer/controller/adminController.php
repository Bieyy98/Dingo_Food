...
function loginAdmin(){
		...
		if($admin->loginadmin()->rowCount() == 1){
			$message = 'Success Login';
                ...
                window.location = '/Dingo_Food/ApplicationLayer/ManageAdminInterface/adminHome.php';
                </script>";
                exit();
		}
		else{
            ...
            echo "<script type='text/javascript'>alert('$message');
            window.location = '/Dingo_Food/ApplicationLayer/ManageAdminInterface/adminLogin.php';
            </script>";
            exit();
		}
}
