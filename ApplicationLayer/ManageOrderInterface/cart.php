              ...
              <div class="card-body">
                <center>
                  <form action="" method="POST">
                   ...
                   <br></br>
                   <td><button style="width: 30%;" class="btn btn--radius-2 btn--black" input type="button" name = "checkout" value="checkout" onclick="location.href='/Dingo_Food/ApplicationLayer/ManageOrderInterface/checkout.php'">Checkout</button></td>
                   <td>&nbsp</td>
                   <td><button style="width: 30%;" class="btn btn--radius-2 btn--black" input type="button" name = "checkout" value="checkout" onclick="location.href = '/Dingo_Food/ApplicationLayer/ManageMenuInterface/viewMenu.php'">CONTINUE SHOPPING</button></td>
...
<!-- CART DETAILS 
  ...
  ?>
                 ...
                 <form class="" id="form3" method="post" action='/Dingo_Food/ApplicationLayer/ManageOrderInterface/checkout.php' align="right">
                   <button type="submit" name="checkout" class="btn btn-primary">CHECKOUT</button>
                 </form>
                 </div>

                 <div style="padding-top:10px;padding-left:500px">
                   <button class="btn btn-dark" onclick="location.href = '/Dingo_Food/ApplicationLayer/ManageMenuInterface/viewMenu.php' ">CONTINUE SHOPPING</button>
