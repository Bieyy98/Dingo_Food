...
require_once 'C:/xampp/htdocs/Dingo_Food/libs/database.php';
require_once 'C:/xampp/htdocs/Dingo_Food/libs/adminSession.php';
//require_once('C:/xampp/htdocs/Dingo_Food/libs/config.php');
  ...
  <div id="content">
    <table id="emp_table" width="100%" border="0" >
      ...
      <tr text-align="center">
        ...
        <td class="solid"><img src="/Dingo_Food/img/<?php echo $row["menu_image"]; ?>" style="width:40px"></td>
